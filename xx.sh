...
data_ip="https://raw.githubusercontent.com/nixy-pro/izin/main/ip"
izin_scripted() {
...
clear;clear;clear
  ...
  # // Banner
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo -e "\033[41;1;97m                    NIXY TUNNELING                    ${NC}"
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo ""
sleep 3
clear
...
# USERNAME
rm -f /usr/bin/user
username=$(curl https://raw.githubusercontent.com/nixy-pro/main/master/ip | grep $MYIP | awk '{print $2}')
...
# REPOSITORY    
    REPO="https://raw.githubusercontent.com/nixy-pro/juara/master/"
...
wget raw.githubusercontent.com/nixy-pro/juara/master/files/limit.sh && chmod +x limit.sh && ./limit.sh
